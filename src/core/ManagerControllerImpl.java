...
public class ManagerControllerImpl implements ManagerController {
    ...
    public String addCard(String type, String name) {
        ...
        String msg = String.format(SUCCESSFULLY_ADDED_CARD,type,name);
    ...
    public String addPlayerCard(String username, String cardName) {
        ...
        String msg = String.format(SUCCESSFULLY_ADDED_PLAYER_WITH_CARDS,cardName,username);
    ...
    public String fight(String attackUser, String enemyUser) {
        ...
        String msg = String.format(FIGHT_INFO,attackPlayer.getHealth(),enemyPlayer.getHealth());
